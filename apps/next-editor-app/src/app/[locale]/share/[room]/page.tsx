...
export default function Document({ params }: { params: { room: string } }) {
  ...
  console.log(`%c 🔝 🚀 : Document -> searchParams `, `font-size:14px;background-color:#e16c5d;color:white;`, searchParams);

  const hasCollab = parseInt(searchParams.get('noCollab') as string) !== 1

  const { room } = params
  console.log(`%c 🇧🇲 🚀 : Document -> room `, `font-size:14px;background-color:#4c0acb;color:white;`, room)
