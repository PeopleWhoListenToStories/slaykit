import { Editor, Fragment, PMNode } from '@slaykit/core'
...
export function copyNode(nodeOrNodeName: PMNode | Fragment<any>, editor: Editor)
export function copyNode(nodeOrNodeName: string, editor: Editor)
export function copyNode(nodeOrNodeName: string | PMNode | Fragment<any>, editor: Editor) {
  let targetNode = null
