import { Decoration, DecorationSet, PMPlugin } from '@slaykit/core'
import { TableHeader as SlaykitTableHeader } from '@slaykit/table'

import { getCellsInRow, isColumnSelected, selectColumn } from './utils'

export const TableHeader = SlaykitTableHeader.extend({
  addAttributes() {
    return {
      colspan: {
        default: 1,
