// @ts-nocheck
import { CellSelection, findParentNode, PMNode, ResolvedPos, Selection, TableMap, Transaction } from '@slaykit/core'
...
export const findParentNodeClosestToPos = ($pos: ResolvedPos, predicate: (node: PMNode) => boolean) => {
