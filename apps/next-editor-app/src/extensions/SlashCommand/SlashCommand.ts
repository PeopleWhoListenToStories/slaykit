...
import { Editor, Extension, PMPluginKey } from '@slaykit/core'
import Suggestion, { SuggestionKeyDownProps, SuggestionProps } from '@slaykit/suggestion'
  ...
  addProseMirrorPlugins() {
    return [
      Suggestion({
        ...
        allowSpaces: true,
        startOfLine: true,
        pluginKey: new PMPluginKey(extensionName),
        allow: ({ state, range }) => {
